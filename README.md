...
|| revisit-after | time period | By using this so called REVISIT-AFTER meta tag you can tell the spider to come back to your website and index it again. This meta tag is used by several North American search engines.| ``` html <meta name="revisit-after" content="period"> ```|
|| reply-to | email address  |By adding the email address of  web master in the REPLY-TO tag you are able to explain how people can contact the right person in organization who is responsible for website. |  |
